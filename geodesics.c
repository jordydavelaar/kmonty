...
void push_photon4(double X[], double K[], double dK[], double dl) {
  ...
  get_connection(X, lconn);
  for (k = 0; k < NDIM; k++) {
    f1k[k] = -2. * (K[0] * (lconn[k][0][1] * K[1] + lconn[k][0][2] * K[2] +
                            lconn[k][0][3] * K[3]) +
                    K[1] * (lconn[k][1][2] * K[2] + lconn[k][1][3] * K[3]) +
                    lconn[k][2][3] * K[2] * K[3]);

    f1k[k] -= (lconn[k][0][0] * K[0] * K[0] + lconn[k][1][1] * K[1] * K[1] +
               lconn[k][2][2] * K[2] * K[2] + lconn[k][3][3] * K[3] * K[3]);
  }
  ...
  for (k = 0; k < NDIM; k++) {
    f2k[k] = -2. * (Kt[0] * (lconn[k][0][1] * Kt[1] + lconn[k][0][2] * Kt[2] +
                             lconn[k][0][3] * Kt[3]) +
                    Kt[1] * (lconn[k][1][2] * Kt[2] + lconn[k][1][3] * Kt[3]) +
                    lconn[k][2][3] * Kt[2] * Kt[3]);

    f2k[k] -= (lconn[k][0][0] * Kt[0] * Kt[0] + lconn[k][1][1] * Kt[1] * Kt[1] +
               lconn[k][2][2] * Kt[2] * Kt[2] + lconn[k][3][3] * Kt[3] * Kt[3]);
  }
  ...
  get_connection(Xt, lconn);
  for (k = 0; k < NDIM; k++) {
    f3k[k] = -2. * (Kt[0] * (lconn[k][0][1] * Kt[1] + lconn[k][0][2] * Kt[2] +
                             lconn[k][0][3] * Kt[3]) +
                    Kt[1] * (lconn[k][1][2] * Kt[2] + lconn[k][1][3] * Kt[3]) +
                    lconn[k][2][3] * Kt[2] * Kt[3]);

    f3k[k] -= (lconn[k][0][0] * Kt[0] * Kt[0] + lconn[k][1][1] * Kt[1] * Kt[1] +
               lconn[k][2][2] * Kt[2] * Kt[2] + lconn[k][3][3] * Kt[3] * Kt[3]);
  }
  ...
  get_connection(Xt, lconn);
  for (k = 0; k < NDIM; k++) {
    f4k[k] = -2. * (Kt[0] * (lconn[k][0][1] * Kt[1] + lconn[k][0][2] * Kt[2] +
                             lconn[k][0][3] * Kt[3]) +
                    Kt[1] * (lconn[k][1][2] * Kt[2] + lconn[k][1][3] * Kt[3]) +
                    lconn[k][2][3] * Kt[2] * Kt[3]);

    f4k[k] -= (lconn[k][0][0] * Kt[0] * Kt[0] + lconn[k][1][1] * Kt[1] * Kt[1] +
               lconn[k][2][2] * Kt[2] * Kt[2] + lconn[k][3][3] * Kt[3] * Kt[3]);
  }

  for (k = 0; k < NDIM; k++) {
    X[k] += 0.166666666666667 * dl * (f1x[k] + 2. * (f2x[k] + f3x[k]) + f4x[k]);
    K[k] += 0.166666666666667 * dl * (f1k[k] + 2. * (f2k[k] + f3k[k]) + f4k[k]);
  }
