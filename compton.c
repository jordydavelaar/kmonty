...
void boost(double v[4], double u[4], double vp[4]) {
  ...
  /*
     ...
     printf("boost udotu %e \n",u[0] * u[0] - u[1] * u[1] - u[2] * u[2] - u[3] * u[3]);
     printf("boost vdotv %e \n",v[0]* v[0] - v[1] * v[1] - v[2] * v[2] - v[3] * v[3]);
     printf("boost u  %e %e %e %e\n",u[0],u[1],u[2],u[3]);
     printf("boost v  %e %e %e %e\n",v[0],v[1],v[2],v[3]);
     }
     */ vp[1] = -u[1] * v[0] + (1. + n1 * n1 * gm1) * v[1] +
...
//    sample_beta_distr(Thetae, &gamma_e, &beta_e, ACCZONE);
    ...
    if (sample_cnt > 10000000) {
      fprintf(stderr, "in sample_electron mu, gamma_e, K, sigma_KN, x1: %g %g "
                      "%g %g %g %g\n",
